...
In this script we present the analysis of performance for different abusive speech related datasets.
...
```{r,echo=FALSE, results="hide"}
# problema 1, quanto maior o dataset mais palavras serao repetidas, e como estou a contar as palavras que sao diferentes isso influencia
...
#print("second model without na")

#model2 <- lm(F1_macro ~ .,
#             data = data_to_keep %>% drop_na())
#summary(model2)
